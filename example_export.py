...
def export_model(
    ...
    **additional_model_kwargs
    ...
    # 1. Instantiates a PyTorch model and converts it to a traced TorchScript format
    checkpoint_path = additional_model_kwargs.pop("checkpoint_path", None)
    ...
    model.input_mean = torch.Tensor([0., 0., 0.]).reshape(1, 3, 1, 1, 1)  # TODO
    model.input_std = torch.Tensor([1., 1., 1.]).reshape(1, 3, 1, 1, 1)  # TODO
    ...
    def custom_sample_inputs(input_spec=None):
        ...
        data_dir = "./datasets/QEVD_sup/val"
